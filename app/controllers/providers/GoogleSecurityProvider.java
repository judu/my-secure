 ...
 */
@Provides("google")
public class GoogleSecurityProvider extends Secure {
   ...
   public static void login(String domain) {
      ...
      Map map = new HashMap();
      map.put("id", finishID);
      manager.setReturnTo("http://" + request.domain + Router.reverse("providers.GoogleSecurityProvider.finishAuth", map));
   ...
   public static String getLoginUrl(ProviderParams pp) {
      ...
      return Router.getFullUrl("providers.GoogleSecurityProvider.login", map);
   }
